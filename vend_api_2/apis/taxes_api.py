...
class TaxesApi(object):
    ...
    def list_taxes(self, **kwargs):
        ...
        >>> thread = api.list_taxes(async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.list_taxes_with_http_info(**kwargs)
        else:
            (data) = self.list_taxes_with_http_info(**kwargs)
            return data

    def list_taxes_with_http_info(self, **kwargs):
        """
        List taxes
        Returns a paginated list of taxes.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_taxes_with_http_info(async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api('/taxes', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
