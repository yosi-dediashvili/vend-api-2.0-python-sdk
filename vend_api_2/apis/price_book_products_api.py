...
class PriceBookProductsApi(object):
    """
    ...
    def list_price_book_products(self, **kwargs):
        ...
        if kwargs.get('async'):
            return self.list_price_book_products_with_http_info(**kwargs)
        else:
            (data) = self.list_price_book_products_with_http_info(**kwargs)
            return data

    def list_price_book_products_with_http_info(self, **kwargs):
        """
        List price book products
        Returns a paginated list of price book products.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_price_book_products_with_http_info(async=True)
        >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_price_book_products" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/price_book_products', 'GET',
                                        ...
                                        response_type='PriceBookProductCollection',
