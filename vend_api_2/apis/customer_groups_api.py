...
class CustomerGroupsApi(object):
    """
    ...
    def list_customer_groups(self, **kwargs):
        """
        List customer groups
        Returns a paginated list of customer groups.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_customer_groups(async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.list_customer_groups_with_http_info(**kwargs)
        else:
            (data) = self.list_customer_groups_with_http_info(**kwargs)
            return data

    def list_customer_groups_with_http_info(self, **kwargs):
        """
        List customer groups
        Returns a paginated list of customer groups.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_customer_groups_with_http_info(async=True)
        >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_customer_groups" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/customer_groups', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='CustomerGroupCollection',
