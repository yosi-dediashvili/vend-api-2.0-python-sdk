...
class PaymentTypesApi(object):
    ...
    def list_payment_types(self, **kwargs):
        """
        List payment types
        Returns a paginated collection of payment types.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_payment_types(async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.list_payment_types_with_http_info(**kwargs)
        else:
            (data) = self.list_payment_types_with_http_info(**kwargs)
            return data

    def list_payment_types_with_http_info(self, **kwargs):
        """
        List payment types
        Returns a paginated collection of payment types.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_payment_types_with_http_info(async=True)
        >>> result = thread.get()
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_payment_types" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/payment_types', 'GET',
                                        ...
                                        response_type='PaymentTypeCollection',
